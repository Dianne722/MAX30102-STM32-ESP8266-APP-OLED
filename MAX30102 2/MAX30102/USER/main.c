...
{ 
	...
	while(1)
	{
		...
		if(dis_hr == 0 && dis_spo2 == 0)  //**dis_hr == 0 && dis_spo2 == 0
		{
			...
			{
				ESP_print(u_hr/ten,u_sp/ten);//采集10次后取平均值
				beep(u_hr/ten,u_sp/ten,MAX_hr,MIN_sp);//检测是否需要报警
				u_hr=0,u_sp=0;
				j=0;
			}
		}
